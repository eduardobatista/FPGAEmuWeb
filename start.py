...
localdburl = 'sqlite:///' + str(Path(WORKDIR,'db2.sqlite')) # WARNING: do not put local database in other place without changing the seckey.
if not Path(WORKDIR,"db2.sqlite").exists():
