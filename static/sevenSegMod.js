...
displayRawValue: function(rawvalue, bDecimalPoint) {
    var self = this;
    //if(!c_aNumberSegments.hasOwnProperty(value)) return;
    self.options.value = self._getKeyByValue(rawvalue);
...
_getKeyByValue: function(value) {
    return Object.keys(c_aNumberSegments).find(key => c_aNumberSegments[key] === value);
},
